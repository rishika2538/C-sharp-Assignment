...
class Program
{
    static void Main()
    {
        ...
        ////2.Data Hiding with Properties(Student)
        //try
        //{
        ...
        ////4.Abstraction with Abstract class(area)
        ...
        //TeacherStudent person1 = new Student1("Alice", 20, "S123");
        //TeacherStudent person2 = new Teacher("Mr. Bob", 40, "Mathematics");
        ...
        ////9.Multiple Inheritance Using Interfaces(Printable)
        //Report report = new Report("This is the annual report.");
        //report.Print();
        //report.SaveToFile("report.txt");


        ////10.Design a Role-Based Access System(User)
